...
let targetBlock = `          <div class="book-info">
            <div class="book-badges">`;

let newBlock = `          <div class="book-info">
` + injection + `
            <div class="book-badges">`;

let lastIndex = html.lastIndexOf(targetBlock);
if (lastIndex !== -1) {
    html = html.substring(0, lastIndex) + newBlock + html.substring(lastIndex + targetBlock.length);
